...
class FlightTest < ActiveSupport::TestCase
	...
	test "arrival_date_time should not be empty" do
		@flight.arrival_date_time = nil
		assert_not @flight.valid?
	end

	test "departure_date_time should not be empty" do
	...
	test "association \"departed_from\" should work" do		
		assert_equal @flight.departed_from, @airport
	end

	test "association \"arriving_to\" should work" do
		assert_equal @flight.arriving_to, @airport2
	end
